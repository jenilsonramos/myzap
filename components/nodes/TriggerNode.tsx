...
const TriggerNode = ({ data, selected }: any) => {
    return (
        <div className={`w-72 group transition-all duration-300`}>
            ...
            <div className={`relative bg-emerald-500/5 dark:bg-emerald-900/10 backdrop-blur-xl rounded-[24px] shadow-sm border transition-all overflow-hidden ${selected ? 'border-emerald-400/50 shadow-[0_8px_30px_-6px_rgba(16,185,129,0.15)] ring-1 ring-emerald-400/20' : 'border-emerald-200 dark:border-emerald-800/30 hover:border-emerald-400/40'}`}>
