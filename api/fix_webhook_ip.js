...
// IP PÚBLICO DO VPS (Descoberto via chat anterior)
const VPS_IP = '194.163.189.247';
const WEBHOOK_URL = `http://${VPS_IP}:5000/api/webhook/evolution`;

async function fix() {
    console.log('🚀 Iniciando Bypass de DNS/SSL para Webhooks...');
    console.log(`🔗 Nova URL Direta: ${WEBHOOK_URL}`);
    ...
    try {
        ...
        // Vamos focar na instância 'cxxx' primeiro ou pegar todas
        ...
        console.log('\n🏁 Bypass Concluído. Tente enviar uma mensagem agora!');
